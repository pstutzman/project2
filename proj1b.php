<!doctype html>
 ...
 /* Name: Paula Stutzman
 Date: 02/03/2017
 File Name: proj1b.php
 Purpose: Modify the program so it can be viewed "nicely"
 in a web browser.
 */
 ?>

 <h1>Paula Stutzman - Project #1 part b</h1>
 <p><em>The purpose of this program is to assign values to a few variables, make a few
calculations <br />on these
 numbers, and output these results to a web browser using "nice" formatting.</em></p>
